...
public class Group implements Serializable{
	...
	public Group(int gNo, String gCreator, String gName, String gCategory, int gMax, Date gDate, String gOpenScope,
			String gJoinSet, String gQset, String q1, String q2, String q3, String gIntro, String gTag, String gStatus,
			String gNotice, String gProfile, String gImage) {
		super();
		this.gNo = gNo;
	...
	public Group(int gNo, String gCreator, String gName, String gCategory, int gMax, Date gDate, String gOpenScope,
			String gJoinSet, String gQset, String q1, String q2, String q3, String gIntro, String gTag, String gStatus,
			String gNotice, String gProfile, String gImage, String gRenameProfile, String gRenameImage) {
		super();
		this.gNo = gNo;
		this.gCreator = gCreator;
		this.gName = gName;
	...
	public String toString() {
		return "Group [gNo=" + gNo + ", gCreator=" + gCreator + ", gName=" + gName + ", gCategory=" + gCategory
				+ ", gMax=" + gMax + ", gDate=" + gDate + ", gOpenScope=" + gOpenScope + ", gJoinSet=" + gJoinSet
				+ ", gQset=" + gQset + ", q1=" + q1 + ", q2=" + q2 + ", q3=" + q3 + ", gIntro=" + gIntro + ", gTag="
				+ gTag + ", gStatus=" + gStatus + ", gNotice=" + gNotice + ", gProfile=" + gProfile + ", gImage="
				+ gImage + ", gRenameProfile=" + gRenameProfile + ", gRenameImage=" + gRenameImage + "]";
	}
